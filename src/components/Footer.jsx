            ...
            <div className="container">
                <div className="row mb-5">
                    <div className="col-md-8">
                        <div className="row">
                            <div className="col-md mb-4"><h2 className="probootstrap-heading probootstrap-footer-logo"><a href="#">Initial</a></h2></div>
                            <div className="col-md">
                                <div className="probootstrap-footer-widget mb-4">
                                    <h2 className="probootstrap-heading-2">Company</h2>
                            ...
                            <div className="col-md">
                                <div className="probootstrap-footer-widget mb-4">
                                    <h2 className="probootstrap-heading-2">Communities</h2>
                                    <ul className="list-unstyled">
                            ...
                            <div className="col-md">
                                <div className="probootstrap-footer-widget mb-4">
                                    <h2 className="probootstrap-heading-2">Useful links</h2>
                                    <ul className="list-unstyled">
                ...
                <div className="row">
                    ...
                    <div className="col-md text-md-right text-left">
                        <p>&copy; Initial 2017. All Rights Reserved. < br /> Made with <span className="icon-heart text-danger"></span>  by <a href="https://uicookies.com/">uiCookies</a></p>
                    </div>
                </div>
            </div>
        </footer>
